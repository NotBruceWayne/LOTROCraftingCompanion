	...
	for i=MAXTIER, 1, -1 do
		...
		if i > _CURPROFESSION.MasteryLevel then
			...
			if i == (_CURPROFESSION.ProficiencyLevel + 1) then
				...
				-- REMAININGXP = (_CURPROFESSION.ProficiencyExperienceTarget - _CURPROFESSION.ProficiencyExperience) - REMAININGXP;
				REMAININGXP = (_CURPROFESSION.ProficiencyExperienceTarget - _CURPROFESSION.ProficiencyExperience);
